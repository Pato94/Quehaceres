...
class MyTasksFragment : Fragment() {
    ...
    private var listener: AvailableTasksFragment.OnListFragmentInteractionListener? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyAvailableTasksRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
    ...
    override fun onAttach(context: Context) {
        ...
        if (context is AvailableTasksFragment.OnListFragmentInteractionListener) {
            listener = context
        } else {
